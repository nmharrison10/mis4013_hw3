...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editRaceModal<?php echo $race['race_id'];?>">
...
<!-- Modal -->
<div class="modal fade" id="editRaceModal<?php echo $race['race_id'];?>" tabindex="-1" aria-labelledby="editRaceModalLabel<?php echo $race['race_id'];?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="editRaceModalLabel<?php echo $race['race_id'];?>">Edit Race</h1>
