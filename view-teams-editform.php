    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="cid<?php echo $team['team_id'];?>" name="cid" value="<?php echo $team['country_id'];?>">
          </div>

          <div class="mb-3">
            <label for="pName<?php echo $team['team_id'];?>" class="form-label">Principal Name</label>
            <input type="text" class="form-control" id="pName<?php echo $team['team_id'];?>" name="pName" value="<?php echo $team['principal'];?>">
          </div>
